      ...
      addAppListener({
        ...
        effect: ({
          ...
          getSearchProfile({
            page: 0,
            pageSize: 100,
            filter: [{ property: "formId", value: "revenue", method: "eq" }],
          });
        },
      })
    );
        ...
        <DialogContent key={key} sx={{ p: "20px 0px" }}>
          <Box px={"32px"} display={"flex"}>
            <Autocomplete
              ...
              store={{
                ...
                params: {
                  filter: [
                    { property: "formId", value: "revenue", method: "eq" },
                  ],
                },
              }}
              {...register("id", {
          ...
          >
            <Grid2 container size={12} mt={1}>
              <Stack width={1}>
                <Typography sx={{ fontWeight: 700 }}>Ngày</Typography>
                <Stack direction={'row'} mt={0.5}>
                  <DateField
                    label={t("Từ")}
                    defaultValue={getValues("transdateFrom")}
                    {...register("transdateFrom")}
                  />
                  <div style={{ minWidth: '36px' }}></div>
                  <DateField
                    label={t("Đến")}
                    defaultValue={getValues("transdateTo")}
                    {...register("transdateTo")}
                  />
                </Stack>
              </Stack>
            </Grid2>
